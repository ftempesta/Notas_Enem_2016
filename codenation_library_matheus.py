...
def master_regression_algorithm(X_train, X_test, y_train, y_test,
    ...
    y_pred_regression, regression =  linear_regression_processing(X_train, X_test,
                                                      y_train, y_test)
    # MAE of regression
    mae_regression =\
    ...
    y_pred_xgboost, feature_importance, xgboost =\
    ...
    y_pred_nn, nn = neural_net_processing(X_train, X_test, y_train, y_test,
                                      batch_size,
                                      epochs,
                                      patience,
                                      min_delta)
    ...
    return df_prediction, df_mae_score, regression, xgboost, svr, nn
